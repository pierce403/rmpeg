...
Compressed decode is not implemented yet. MP3, FLAC, Opus, Vorbis, AAC, H.264, HEVC, VP8, VP9, AV1, Matroska/WebM, DDS, PNG/APNG, BMP, SGI, PSD, JPEG/MJPEG, WebP, Sun Raster, OpenEXR, JPEG 2000, TGA, TIFF, and PNM image support is probe-level metadata only.
