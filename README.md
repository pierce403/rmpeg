...
- CDG, DXA, GDV, RPL, EA MAD, Pictor, QuickDraw PICT/MOV, PTX, XBM, X-Face, binary text, and Westwood VQA video/image metadata probing
...
Current Phase 1 strict corpus progress is 1904 of 2178 FFmpeg-accepted samples, or 87.420%, on the local upstream sample report.
