...
Current local full-corpus snapshot from 2026-06-14 after narrow MXF/IMF CPL/HE-AAC metadata probing:

```text
1999 / 2178 strict media matches = 91.8%
2331 / 2511 total corpus passes, including files both ffprobe and rmpeg reject
0 corpus errors
