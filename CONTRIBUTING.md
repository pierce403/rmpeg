...
Current local full-corpus snapshot from 2026-06-13 after MP4 AAC/ALS `esds` probing:

```text
1382 / 2178 strict media matches = 63.5%
1714 / 2511 total corpus passes, including files both ffprobe and rmpeg reject
0 corpus errors
